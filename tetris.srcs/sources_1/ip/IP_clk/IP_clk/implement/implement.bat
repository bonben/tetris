...
xst -ifn xst.scr
move IP_clk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\IP_clk_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc IP_clk_exdes.ucf IP_clk_exdes

echo 'Running map'
map -timing -pr b IP_clk_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm IP_clk_exdes -w routed.ncd routed.vhd
cd ..
